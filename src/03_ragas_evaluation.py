...
# Implemented: Copy SYSTEM_V1 và SYSTEM_V2 mà bạn đã viết ở file 02_prompt_hub_ab_routing.py
SYSTEM_V1 = (
...
def run_rag(retriever, llm, prompt, question: str) -> dict:
    ...
    """
    # Implemented: Retrieve documents từ retriever
    docs = retriever.invoke(question)

    # Implemented: Tạo contexts là danh sách page_content (KHÔNG ghép chuỗi ở đây)
    # Gợi ý: contexts = [doc.page_content for doc in docs]
    contexts = [doc.page_content for doc in docs]

    # Implemented: Ghép contexts thành 1 string để truyền vào {context} của prompt
    ctx_str = "\n\n".join(contexts)

    # Implemented: Chạy chain (prompt | llm | StrOutputParser()).invoke(...)
    answer = (prompt | llm | StrOutputParser()).invoke({
        "context": ctx_str,
        "question": question,
    })

    # Implemented: Trả về dict với answer và contexts (list)
...
def collect_rag_outputs(vectorstore, prompt_version: str) -> list:
    ...
    for i, qa in enumerate(QA_PAIRS, 1):
        # Implemented: Gọi run_rag() cho câu hỏi hiện tại
        out = run_rag(retriever, llm, prompt, qa["question"])

        # Implemented: Append vào results dict với 4 keys
        results.append({
...
def build_ragas_dataset(rag_results: list) -> EvaluationDataset:
    ...
    """
    # Implemented: Tạo list các SingleTurnSample từ rag_results
    samples = [
        SingleTurnSample(
    ...
    # Implemented: Wrap thành EvaluationDataset và trả về
...
def run_ragas_eval(rag_results: list, version: str) -> dict:
    ...
    # Implemented: Tạo EvaluationDataset từ rag_results
    ...
    # Implemented: Gọi evaluate() với đầy đủ 4 metrics
    # Gợi ý:
    #   result = evaluate(
    #       dataset,
...
def main():
    ...
    # Implemented: Lưu báo cáo vào data/ragas_report.json
    report = {
    ...
    # Implemented: Ghi report vào file bằng json.dumps hoặc json.dump
